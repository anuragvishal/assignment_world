...
--
-- Host: localhost:3306
-- Generation Time: Nov 12, 2017 at 05:34 PM
...
(25, 'Can add country language', 9, 'add_countrylanguage'),
(26, 'Can change country language', 9, 'change_countrylanguage'),
(27, 'Can delete country language', 9, 'delete_countrylanguage');
...
(1, 'pbkdf2_sha256$36000$s8fgga7xGSuT$v7t6Ik8ds3aomAXq/XN3nDyVcRqQi5pU7CJrk5XDnZU=', '2017-11-12 07:18:18.701804', 1, 'rose', '', '', 'rose@gmail.com', 1, 1, '2017-11-12 07:18:01.820366');
...
--
-- Table structure for table `countrylanguage_countrylanguage`
--

CREATE TABLE `countrylanguage_countrylanguage` (
  `id` int(11) NOT NULL,
  `country_code` varchar(3) NOT NULL,
  `language` varchar(20) NOT NULL,
  `is_official` varchar(1) NOT NULL,
...
(8, 'country', 'country'),
(9, 'countrylanguage', 'countrylanguage'),
(6, 'sessions', 'session');
...
(1, 'contenttypes', '0001_initial', '2017-11-11 20:34:27.649647'),
(2, 'auth', '0001_initial', '2017-11-11 20:34:36.395283'),
(3, 'admin', '0001_initial', '2017-11-11 20:34:39.552737'),
(4, 'admin', '0002_logentry_remove_auto_add', '2017-11-11 20:34:39.712388'),
(5, 'contenttypes', '0002_remove_content_type_name', '2017-11-11 20:34:40.829149'),
(6, 'auth', '0002_alter_permission_name_max_length', '2017-11-11 20:34:40.942198'),
(7, 'auth', '0003_alter_user_email_max_length', '2017-11-11 20:34:41.122721'),
(8, 'auth', '0004_alter_user_username_opts', '2017-11-11 20:34:41.188791'),
(9, 'auth', '0005_alter_user_last_login_null', '2017-11-11 20:34:41.692773'),
(10, 'auth', '0006_require_contenttypes_0002', '2017-11-11 20:34:41.727525'),
(11, 'auth', '0007_alter_validators_add_error_messages', '2017-11-11 20:34:41.790378'),
(12, 'auth', '0008_alter_user_username_max_length', '2017-11-11 20:34:42.128559'),
(13, 'city', '0001_initial', '2017-11-11 20:34:42.482800'),
(14, 'country', '0001_initial', '2017-11-11 20:34:42.802809'),
(15, 'countrylanguage', '0001_initial', '2017-11-11 20:34:43.097608'),
(16, 'sessions', '0001_initial', '2017-11-11 20:34:43.628723');
...
('derxouik04z20ojjyke2ph2siw8bzae9', 'MTM4MWVlMGQ4OTMyYzM5M2ZmMWQ5NDBkNTgyY2UwNmJhZDI2NzNhYzp7Il9hdXRoX3VzZXJfaGFzaCI6ImMxNjFiYzc1ODAyN2RjNzYwMDYwMjY0MTgxYzk4OTkwMzFjNTcxZjEiLCJfYXV0aF91c2VyX2JhY2tlbmQiOiJkamFuZ28uY29udHJpYi5hdXRoLmJhY2tlbmRzLk1vZGVsQmFja2VuZCIsIl9hdXRoX3VzZXJfaWQiOiIxIn0=', '2017-11-26 07:18:18.792306');
...
INSERT INTO `users` (`id`, `email_id`, `first_name`, `last_name`, `gender`, `phone_number`) VALUES
(1, 'sammy@gmail.com', 'sammy', 'smith', 'M', '986532658');
...
--
-- Indexes for table `countrylanguage_countrylanguage`
--
ALTER TABLE `countrylanguage_countrylanguage`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `city_city`
--
ALTER TABLE `city_city`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `countrylanguage_countrylanguage`
--
ALTER TABLE `countrylanguage_countrylanguage`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
